...
@Composable
fun SearchViewEbay(viewModel:SearchViewModel) {
    ...
    Column {
        ConstraintLayout(
            ...
            Search_TextField(
                ...
                onSearch = {viewModel.newSearchEbay(context)
                }
            )
...
@OptIn(ExperimentalAnimationApi::class)
@Composable
fun SearchViewAmazon(viewModel:SearchViewModel) {
    val context = LocalContext.current
    var expandedFilter by remember {
        mutableStateOf(false)
    }
    Column {
        ConstraintLayout(
            ...
            Search_TextField(
                ...
                value = viewModel.query.value,
                onSearchChange = {viewModel.onQueryChanged(it)},
                onSearch = {viewModel.newSearchAmazon(context)
                }
            )
